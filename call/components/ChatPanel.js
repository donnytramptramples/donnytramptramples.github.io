        ...
        <div className="p-4 border-t border-gray-700">
          <div className="flex gap-2">
            <input
              ...
              disabled={!isReady}
              className="flex-1 bg-[var(--dark-surface)] border border-gray-600 rounded px-3 py-2 text-sm focus:outline-none focus:border-[var(--primary-color)] transition-colors disabled:opacity-50"
            />
            <button 
              onClick={handleSend} 
              disabled={!isReady}
